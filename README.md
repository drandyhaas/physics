...
finished document plus whatever source or code produces it, and each has its
own README. Built PDFs are committed so they can be read without installing
anything.
...
- **The built artefact is committed** (PDF), alongside its source.
